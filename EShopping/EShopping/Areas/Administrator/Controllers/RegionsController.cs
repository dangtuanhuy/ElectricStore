...
namespace EShopping.Areas.Administrator.Controllers
{
    public class RegionsController : Controller
    {
        ...
        // GET: Administrator/Regions
        public ActionResult Index()
        {
            return View(db.Regions.ToList());
        }

        // GET: Administrator/Regions/Details/5
        ...
        // GET: Administrator/Regions/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Administrator/Regions/Create
        ...
        // GET: Administrator/Regions/Edit/5
        ...
        // POST: Administrator/Regions/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Administrator/Regions/Delete/5
        ...
        // POST: Administrator/Regions/Delete/5
